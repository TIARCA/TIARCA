...
/** Collects the standard 348/349 channel exception-list numerics. */
public class ExceptionListCommandHandler implements CommandHandler {

    public interface Callback { void onExceptionList(List<Entry> entries); }
    ...
    @Override public Object[] getHandledCommands() { return new Object[] { 348, 349 }; }
    ...
    public synchronized void handle(ServerConnectionData connection, MessagePrefix sender,
        ...
        if (numeric == 348) {
            ...
            callback.onExceptionList(entries == null ? new ArrayList<>() : entries);
        }
    }
}
