...
public class IRCLinkActivity extends ThemedActivity {
    ...
    private ActivityResultLauncher<Intent> mAddServerLauncher;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mAddServerLauncher = registerForActivityResult(
                new ActivityResultContracts.StartActivityForResult(), result ->
                        handleAddedServer(result.getData()));
    ...
    private void handleAddedServer(Intent data) {
