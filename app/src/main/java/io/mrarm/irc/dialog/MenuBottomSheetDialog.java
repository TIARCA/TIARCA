...
public class MenuBottomSheetDialog extends ProperHeightBottomSheetDialog {
    ...
    public void addItem(CharSequence text, int iconId, OnItemClickListener listener) {
        addItem(text, iconId, true, listener);
    }

    public void addItem(CharSequence text, int iconId, boolean enabled,
    ...
    protected class ItemHolder extends RecyclerView.ViewHolder {
        ...
        public ItemHolder(View itemView) {
            ...
            itemView.setOnClickListener((View v) -> {
                ...
                if (item.mEnabled && item.mClickListener != null && item.mClickListener.onClick(item))
                    dismiss();
            });
        }
        ...
        public void bind(Item item) {
            ...
            itemView.setEnabled(item.mEnabled);
            itemView.setAlpha(item.mEnabled ? 1.0f : 0.38f);
        }
