...
public class EditNotificationSettingsActivity extends ThemedActivity
        implements SettingsListAdapter.ActivityResultHost {
    ...
    ActivityResultLauncher<Intent> mAndroidNotificationSettingsLauncher;
    ActivityResultLauncher<Intent> mSettingsActivityLauncher;
    int mPendingSettingsRequestCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAndroidNotificationSettingsLauncher = registerForActivityResult(
        ...
        if (mEditingRule != null) {
            mAdapter.add(new ClickableSetting(getString(
                    ...
                    .setOnClickListener((View v) -> {
                        ...
                        mAndroidNotificationSettingsLauncher.launch(intent);
                    }));
        }
    ...
    private boolean hasNotificationRuleChanges() {
        if (mEditingRule == null || mEditingRule.settings.notificationChannelId == null)
            return false;
    ...
    private void loadNotificationRuleSettings() {
        if (mEditingRule == null || mEditingRule.settings == null ||
    ...
    @Override
    public void launchSettingsActivity(Intent intent, int requestCode) {
        ...
        public AddRuleEntryHolder(View itemView, SettingsListAdapter adapter) {
            ...
            itemView.setOnClickListener((View v) -> {
                ...
                if (position != RecyclerView.NO_POSITION)
                    adapter.add(position, new RuleEntry(
                            NotificationRule.AppliesToEntry.channelMessages()));
            });
        }
