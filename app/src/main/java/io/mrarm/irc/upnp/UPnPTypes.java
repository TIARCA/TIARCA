...
public class UPnPTypes {
    ...
    public static final String UPNP_INTERNET_GATEWAY_DEVICE_V2 = UPNP_DEVICE_PREFIX +
            "InternetGatewayDevice:2";
    public static final String UPNP_WAN_CONNECTION_DEVICE_V1 = UPNP_DEVICE_PREFIX +
            "WANConnectionDevice:1";
    public static final String UPNP_WAN_CONNECTION_DEVICE_V2 = UPNP_DEVICE_PREFIX +
