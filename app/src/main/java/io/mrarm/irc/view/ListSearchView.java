...
public class ListSearchView extends FrameLayout {
    ...
    public ListSearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStatusBarColor = ContextCompat.getColor(getContext(), R.color.searchColorPrimaryDark);
    }
    ...
    public void onVisibilityAggregated(boolean isVisible) {
        ...
        if (isVisible)
            ...
            hideKeyboard();
        if (mDialog != null && isLightColor(mStatusBarColor)) {
            WindowInsetsControllerCompat controller = WindowCompat.getInsetsController(
                    mDialog.getWindow(), mDialog.getWindow().getDecorView());
