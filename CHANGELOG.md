...
- Configurazione e preferenze sono persistenti e incluse nel backup/ripristino; nessun polling è utilizzato quando il server supporta MONITOR.

### Server e interfaccia

- Corretto il menu rapido utente affinché i comandi di moderazione siano visibili solo quando l'utente locale dispone dei privilegi necessari nel canale interessato.
- Aggiunto un controllo esplicito per evitare comandi operatore su nickname/ident/host non validi o non disponibili.

## v0.7.4

- Migliorata la gestione dei link temporanei e dei contenuti condivisi.

## v0.7.3

- Corrette diverse anomalie minori nell'interfaccia e nella gestione delle connessioni.

## v0.7.2

- Migliorata la stabilità generale dell'app e la compatibilità Android.

## v0.7.1

- Corrette regressioni minori della serie 0.7.

## v0.7.0

- Prima release della serie TIARCA 0.7 con il nuovo ciclo di sviluppo e rilascio del fork.
